...
7. **Promote deliberately** — after explicit approval, compress the accepted rule into canonical form and update affected registers, indexes, specifications, or roadmaps. Do not promote adjacent conversation automatically.

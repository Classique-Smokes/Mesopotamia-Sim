...
**Status:** CANDIDATE — pending governance evaluation and constitutional promotion  
**Authority when promoted:** Master Architect operating protocol subordinate to the Project Seed, Working Constitution, accepted semantics/architecture, and Master Architect Guide  

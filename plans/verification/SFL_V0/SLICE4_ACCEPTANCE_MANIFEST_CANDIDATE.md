...
**Independent pre-code review:** REQUIRED before freeze  
...
This candidate is verification/completion authority subordinate to accepted semantics. It cannot create or amend social rules.
...
**Prior frozen REQUIRED total:** 269 = 128 Slice 1 + 45 Slice 2 + 96 Slice 3.
...
Inherited frozen REQUIRED obligations additionally preserved one-by-one: **269 = 128 Slice 1 + 45 Slice 2 + 96 Slice 3**.

A freeze record must pin:
...
## 10. Freeze / implementation rule

This candidate is **not frozen authority**.

Required sequence:

1. fresh independent pre-code review of this exact candidate against accepted SPEC/ADRs/DEC-0010/canonical verification/frozen prior manifests;
2. repair any omission, overreach, unsupported wording, fixture leak, oracle circularity, or inherited-adaptation ambiguity;
3. freeze only exact content that receives **PASS — MAY FREEZE UNCHANGED**;
4. complete/independently approve triggered inherited verification adaptations before production coding touches those surfaces;
5. issue the bounded Slice-4 implementation packet only after both acceptance freeze and adaptation closure.

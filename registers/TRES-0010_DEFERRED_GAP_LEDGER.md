...
| LATER-04 | Authority-destroying transition versus already accepted authority-dependent action in same cycle | **FIRED / PENDING DIRECTOR DECISION** | Slice-4 discovery established one bounded precedence choice is required before acceptance freeze/coding. Decision packet: `proposals/SFL_V0_SLICE4_LATER_04_AUTHORITY_RACE_DECISION.md`. | No prior-slice semantic change; now blocks Slice-4 freeze until approved. |

...
- **Action:** Establish canonical root build/test/analyzer commands and CI that executes them.
...
- **Action:** Prevent implementation agents from silently weakening the tests/graders/invariants that define completion; use independent or protected checks where consequence warrants.
- **Evidence:** `research/technical/HARNESS_ENGINEERING_STUDY_SYNTHESIS.md`

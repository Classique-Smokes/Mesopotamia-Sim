# IMP-0003 — Fresh Independent Post-Implementation Conformance Review
...
**Implementation candidate ref:** `imp-0003-slice3-conformance-candidate-v1`  
...
**Evidence artifact:** `10772553766`, `sfl-slice1-slice2-slice3-acceptance-evidence`, digest `sha256:b345696d803d25beeb574d5b261748d4c88776ea81a81d7a7a20ef7e64350029`  
**Required return path:** `research/technical/IMP-0003/IMP-0003_INDEPENDENT_CONFORMANCE_REVIEW_FRESH.md`

## 1. Purpose

Independently determine whether exact candidate `6b9d40e33b94d9094c02fe3d9f026914dd7986ec` conforms to:
...
You must not be the IMP-0003 implementation author.
...
11. exact candidate diff against canonical parent `77f3d1dd9630401ff6bba0b38283a823e26d2a01`.
...
- verify `imp-0003-slice3-conformance-candidate-v1` resolves exactly to `6b9d40e33b94d9094c02fe3d9f026914dd7986ec`;
...
- run `35910481737` belongs to exact candidate SHA;
- run conclusion is success;
- artifact `10772553766` exists, is unexpired, and has digest:
  `sha256:b345696d803d25beeb574d5b261748d4c88776ea81a81d7a7a20ef7e64350029`;
...
Pay particular attention to the coder-reported discoveries:

- newcomer residence/admission dependency grouping defect found and repaired;
- dissolution knowledge leakage narrowed so only the terminal exiting participant gets direct dissolution acquisition.
...
`review/imp-0003-conformance-independent-return`

from exact candidate SHA:

`6b9d40e33b94d9094c02fe3d9f026914dd7986ec`

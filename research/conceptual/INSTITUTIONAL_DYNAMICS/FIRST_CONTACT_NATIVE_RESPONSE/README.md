# Wonder Gather Native-Perspective Response Intake

**Status:** DURABLE NON-AUTHORITATIVE RESEARCH INTAKE  
**Authority:** none  
**Purpose:** preserve and decompose the first blind-delivery response to `A_TABLET_OF_QUESTIONS_SENT_ACROSS_THE_BORDER.md` before interpretive synthesis.

This directory exists to prevent a large first-pass synthesis from becoming the only surviving representation of the response.

The response is treated as a foreign institutional artifact. It is not accepted Mesopotamia-Sim semantics, historical evidence, architecture, or implementation authority.

## Intake rule

Preserve, in order:

1. delivery provenance;
2. exact source identity;
3. document structure;
4. questionnaire coverage;
5. question-bounded native summaries;
6. cross-answer concept map;
7. only then comparative Uruk analysis.

Do not rewrite the foreign response to fit Uruk terminology.

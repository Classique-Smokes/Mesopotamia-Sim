# RES-0001 Research Manifest

**Recovered:** 2026-09-21  
**Authority:** advisory / non-authoritative

| Stream | Original source archive SHA-256 | Current durable Git location |
|---|---|---|
| A | `32f7caf03ab91c71b841283eb7aa789d0f208b1badcd66f4b7c24b98fc5d8406` | `returns/A/` — result plus unique source/audit/validation support |
| B | `7cfa896695ce5dd438de86dc1f0254e7b128968f5f214a31eda2bb8283642094` | `returns/B/` — result plus inventory/evidence/process/source/QA support |
| C | `531a8d8c4cf82f9a0a21f943fdf171bed615650e736daa8567eabe5924152338` | `returns/C/` — result plus document/evidence/process/source/audit/validation support |
| D | `a755beb2901a3f438adaa33aab81ac14df831eb930909c07ba2867dfb0ccfaca` | `returns/D/` — result plus case/evidence/rights/source/coverage/validation support |
| E | `1c1d4685930ab1bec4468c4bdbe0f08c692e30d7512d0bc2066b804d6fb2f2cb` | `returns/E/` — result plus evidence/data/validation support |
| F | `65169e3ba8ca95b38fecbc2c9f92378aa4ee7f8e104d0c18f413c5be5d2eca7b` | `returns/F/` — result plus appendices/execution-plan/README support |
| G | `3128eb99ec224d8a19498fd1fce750871bf9c1f14ba25f151e69fec8d5920049` | `returns/G/` — result plus evidence/interface/notes/source/QA support; authoritative result blob `d9d9fb08631857ee31386d593c14d8e4f2c26446` |
| H | `b8feb4b20c16e19404bd894339bec46555c8b6e85909dafa5f4cf1b6c56841cb` | `returns/H/` — result plus attestation/evidence/audit support; authoritative result blob `1fa7b443c51c76fdb26d4e3ef3b468c7cb4cda33` |

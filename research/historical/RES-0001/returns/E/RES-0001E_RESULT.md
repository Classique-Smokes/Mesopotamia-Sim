# RES-0001E — Research Return
## Labor, Dependency, Slavery, and Service

**Packet ID:** RES-0001E  
**Researcher/agent:** ChatGPT, task 5 research workstream  
**Date completed:** 19 September 2026  
**Status:** Completed research return; advisory evidence, not an exhaustive corpus edition.  
**Scope actually covered:** Selected Old Babylonian Nippur legal documents concerning hire, maintenance, adoption, marriage, estate allocation, cultivation, temple-related livelihood rights, and an attributed Nippur manumission; selected educational evidence and comparative scholarship.  
**Important scope deviations:** The directly checked transactional evidence is concentrated in the reigns of Rim-Sin I and Samsu-iluna, not uniformly across 1900–1600 BCE. Modern editions and the principal residential-context monograph were not all accessible. No securely identified room-by-room reconstruction of workers’ residence, and no independently verified apprenticeship contract or enslaved family genealogy, is supplied. Those are evidence/access gaps, not findings that the relationships did not exist.  
**Authority:** All propositions are candidates for reconciliation. No canonical `HE-` identifiers, household-membership rules, status hierarchy, or design decisions are assigned.

**Reading guide.** Section 3 is the required claim-level evidence table. Section 4.1 is the required status-dimensions table. Section 8 supplies eight register-ready candidates. The companion evidence notes preserve object-level checks and rejected inferences. Bracketed source keys resolve to the full bibliography in section 9; ancient text numbers and printed page numbers are supplied wherever used. “Unknown” means not established by the material consulted, never “absent.”

## 1. Executive findings

| Finding | Confidence | Chronological/context limit | Best supporting sources |
|---|---|---|---|
| A father-mediated hire can combine kinship and paid work without revealing the worker’s full legal status. | HIGH | One Nippur contract, Samsu-iluna 20 | BE 6/2 51; [P1909], p. 43 |
| Inheritance-linked support is documented for both an adopted son and a son by the wife, and in another agreement for sons attached to a wife as their mother. | HIGH | Two Nippur agreements, Samsu-iluna 8 and 18 | BE 6/2 28, 48; [P1909], pp. 29–30, 35–38 |
| Named enslaved people were allocated in family property divisions; the allocation does not identify their occupations, residence, or own kin ties. | HIGH | BE 6/2 23, Samsu-iluna 4 | [P1909], pp. 20–22 |
| A clause threatening sale after repudiation is not a record that the person was already enslaved or was subsequently sold. | HIGH | BE 6/2 24 and related conditional clauses | [P1909], pp. 27–31, 35–38 |
| A paid manumission is recorded in BE 6/2 8, but its Nippur attribution must be qualified. | MODERATE | Rim-Sin 51; CBS 9183 | [P1909], pp. 38–39; [AMAS2026], p. 116; [CDLI8] |
| Family property arrangements could include time-defined temple office rights and associated livelihood land. | HIGH | BE 6/2 43, Samsu-iluna 13 | [P1909], pp. 22–23 |
| A cultivation lease is a different documented relation from a personal hire; neither determines the participant’s whole status. | HIGH | BE 6/2 29 and 51 | [P1909], pp. 43–44 |
| Marital breach provisions differ: one agreement threatens sale, another gives financial consequences. | HIGH | BE 6/2 40 and 48; Samsu-iluna 13 and 18 | [P1909], pp. 35–38 |
| Instruction is attested without establishing an apprenticeship, fee, indenture, or co-residence. | MODERATE | CBS 14156, Old Babylonian Nippur | [T1998], p. 45 fig. 9 |
| Manumission models cannot be counted as completed releases. | MODERATE | Nippur model corpus; edition access qualified | [SP2021], p. 287 n. 13 |

## 2. Corpus and method actually used

### 2.1 Evidence layers and the actual work performed

The central evidence is a selectively read **primary edition**, not a new reading of original tablets. Poebel’s published transliterations, translations, commentary, and catalogue were checked against one another. The principal dossiers here are BE 6/2 8, 23, 24, 28, 29, 40, 43, 48, and 51; BE 57 supplies a limited parallel, and BE 4 was examined but its occupational interpretation was withheld. The ancient documents are cited individually. Poebel’s 1909 generalizations about Nippur, adult adoption, payment practices, or residence are not automatically adopted as facts. [P1909]

Object numbers, regnal dates, and edition concordances were cross-checked where accessible through CDLI and Stone and Zimansky’s catalogue. These are different evidentiary operations: a catalogue entry can identify a tablet without supplying a reliable translation of every clause. The 1976 volume contains short descriptions and photographs; it is not the complete text edition initially implied by the broad label “contracts.” [SZ1976]

Modern scholarship was used to identify disagreements and additional texts, especially for the Ur-Pabilsaĝa dossier, nadītu women, teaching, and legal models. The return distinguishes an ancient text read in an accessible edition, a modern scholar’s interpretation of it, a source known only through a citation, and the present report’s own bounded inference. This distinction applies even when the same tablet has several publication numbers.

### 2.2 Chronology and provenance

Dates are retained as **ruler / regnal year / month / day**, using Roman numerals for months. A missing day remains missing. This avoids introducing an unannounced absolute-chronology conversion. Most securely attributed legal examples cluster within Samsu-iluna 4–22; supplementary catalogue entries reach year 28. BE 8 is Rim-Sin I 51. BE 4, Rim-Sin I 23, is an excluded occupational lead rather than a foundation for the conclusions. [P1909, catalogue pp. 145–152; SZ1976; CDLI8; CDLI4]

“Nippur” here is normally **documentary/catalogue provenance**, not proof of an identified house, room, or occupation surface. For the principal cases, this investigation has not independently recovered a secure connection between every person in a document and a particular residential locus. An archive attribution based on people and transactions is also not the same thing as an excavated household group.

BE 8 is separately labeled **attributed Nippur** throughout. Its older Yokha designation and the modern argument for Nippur are retained rather than silently resolved by choosing a database’s headline. The detailed audit is in section 5.1 and the evidence notes. [P1909, pp. 1, 38–39; AMAS2026, p. 116 nn. 7–8; CDLI8]

### 2.3 Access limits and sample bias

The complete texts of **Stone 1987**, **Stone and Owen 1991**, **Goddeeris 2016**, and **Spada 2018** were not retrieved for direct consultation. Publisher records, concordances, and references in accessible scholarship were checked; those operations are labeled separately in the ledger. The institutional record for **Goddeeris 2023** was accessible, but its listed PDF was restricted. The report consequently does not claim a complete reassessment of modern readings or residential archaeology. [S1987; SO1991; G2016; SP2018; G2023]

This is a purposefully selected set of legible legal relationships, not a representative sample of inhabitants. Contracts preserve the interests a transaction or dispute needed to specify. They are particularly informative about named parties, rights, obligations, property, and possible breaches; they frequently leave the labor process, dwelling arrangements, personal age, and unrecorded relationships unspecified. That source limitation is visible in the individual cases below rather than inferred from a supposed census denominator. [P1909, texts 23, 24, 28, 29, 40, 43, 48, 51]

No percentages of enslaved persons, typical household size, average wage, frequency of manumission, or standard age of work have been calculated. There is no defensible denominator for such calculations in this return.

## 3. Evidence table

The confidence rating applies to the **narrow proposition**, not to all interpretations of the tablet or to its representativeness. A clear singleton can support high confidence about what that particular agreement specifies, while leaving broader prevalence unknown.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| E-C01 | BE 6/2 51 records Idin-Ištar, explicitly the son of Nabi-Šamaš, hired from Nabi-Šamaš by Lu-Ninsianna for a fixed term with a monthly grain payment. | Samsu-iluna 20/III/21; service III/21–XII/30 | Nippur legal document; Istanbul Ni 1847; no room-level context established | Primary edition | BE 6/2 51, Ni 1847; P1909 p. 43; catalogue p. 151. Monthly amount: 80 qa of grain in the edition. | Poebel’s suggestion of payment at the end of the term is commentary, not an explicit clause. | The occupation, age, residence, precise payment recipient, and ownership status are not stated. | HIGH | One hire agreement; not a standard wage, a census of hired workers, or proof of child labor or free self-contracting. | A kin relationship and a paid work arrangement appear together without becoming the same relationship. | NO DESIGN DECISION |
| E-C02 | Nippur agreements connect filial or adoptive relationships with inheritance-linked maintenance obligations; these are not identical to ownership of the obligated person. | Samsu-iluna 8/III and 18/IV/1 | BE 6/2 28: Ibkuša and two sons; BE 6/2 48: Awilia, Naramtum, and three sons; Nippur | Primary editions, metadata cross-check | BE 6/2 28, CBS 11173, P266334, P1909 pp. 29–30; BE 6/2 48, Ni 1919, P283604, pp. 35–38. | P1909 discusses maintenance and adoption together. The report retains the clauses without adopting a universal old-age explanation. | Maintenance supplies do not identify who produced them. Birth/adoptive relations do not establish age or co-residence. | HIGH | The specified agreements, not all adopted persons, all sons, or all household labor. | Distinguishes support obligations and created kinship from enslavement and occupational work. | NO DESIGN DECISION |
| E-C03 | BE 6/2 23 allocates four named enslaved people between the shares of Narubtum and Ur-Pabilsaĝa. | Samsu-iluna 4/X/21 | Nippur; Ur-Pabilsaĝa/interconnected family dossier; Istanbul Ni 1917 | Primary edition, with modern disagreement check | BE 6/2 23, P1909 pp. 20–22; catalogue p. 147. Ali-aḫuša and Iškur-rīm-ilī in Narubtum’s portion; Dumqi-Ištar and Taribum in Ur-Pabilsaĝa’s. | VW2018 pp. 21–22 records competing reconstructions of the closing kinship/adoption clause. | The contested genealogy does not erase the allocations. The text does not assign these people particular jobs or identify their own family ties. | HIGH | A property division, not a headcount of co-residents or an occupational roster; no transfer itinerary established. | Shows ownership interests passing through family property arrangements while residence and labor remain unrecorded. | NO DESIGN DECISION |
| E-C04 | BE 6/2 24 stipulates sale following adoptees’ repudiation of their adoptive parents; the clause does not report that repudiation or sale occurred. | Samsu-iluna 4/XI | Nippur; Ea-idinnam, Kuritum, Ili-idinnam, and Ili-ummati; CBS 10891, P266084 | Primary edition | BE 6/2 24, P1909 pp. 27–29; catalogue p. 148. Additional conditional language is present in BE 6/2 57. | P1909’s translation distinguishes the adoption from future breach conditions. | No enforcement event is documented in this text; it does not establish prior enslaved status. | HIGH | Not a citywide rule that every adopted person was enslaved or every breach was actually punished this way. | A status-changing sanction must remain distinct from a person’s status when the contract was drawn up. | NO DESIGN DECISION |
| E-C05 | BE 6/2 8 records Ištar-rabiat’s manumission, a payment of ten shekels to Duššubtum, and protection against named heirs’ future claims; its Nippur attribution requires a provenance qualification. | Rim-Sin I 51/V | CBS 9183, P264577; probable Nippur documentary origin, conflicting historical find attribution, no secure house/locus | Primary edition plus current provenance research/catalogue | BE 6/2 8, P1909 pp. 38–39; CDLI8. | AMAS2026 p. 116 nn. 7–8 supports Nippur from internal evidence; CDLI adopted this attribution in 2026. | Poebel labels the tablet Yokha. Neither the source of the payment nor later residence is stated. | MODERATE | Not securely excavated domestic evidence, not a general slave savings right, and not evidence that manumission always ended other dependence. | Preserves an attested status change and transaction while separating documentary origin, legal effect, and subsequent livelihood. | NO DESIGN DECISION |
| E-C06 | BE 6/2 43 places a six-month annual Enlil priestly office share and associated livelihood land within a family property division. | Samsu-iluna 13/XII | Nippur; Igi-šag and Sin-išmeanni; CBS 7016 | Primary edition, with catalogue corroboration for transferable office terms | BE 6/2 43, P1909 pp. 22–23; catalogue p. 150. SZ1976 nos. 19 and 32 provide additional office-transfer leads. | The report uses “office share/right” for the economic relationship without asserting a fully reconstructed service regime. | Possession of rights does not prove that the holder personally performed every duty or establish residence in a temple. | HIGH | This office arrangement, not an institutional labor taxonomy or an assumption that all temple-linked people were dependents of one type. | Household property and institution-linked livelihood could intersect without making them interchangeable. | NO DESIGN DECISION |
| E-C07 | BE 6/2 29 records Damu-idinnam’s lease of Ibgatum’s field for cultivation at one-third of returns as annual rent. | Samsu-iluna 11/III | Nippur; CBS 10890; field transaction | Primary edition | BE 6/2 29, P1909 pp. 43–44; catalogue p. 148. | Poebel distinguishes the field lease from the personal hire of BE 6/2 51. | The labor force, household residence, and lessee’s broader status are not specified. | HIGH | Not proof of tenant enslavement, self-performed labor, or a standard tenancy arrangement throughout the city. | An economic obligation to produce or render returns does not by itself identify the legal status of the cultivator. | NO DESIGN DECISION |
| E-C08 | BE 6/2 48 and 40 prescribe different consequences for a wife’s repudiation: the former includes sale, while the latter specifies financial consequences. | Samsu-iluna 18/IV/1 and 13/I; day of BE 40 not fixed here | Nippur; Naramtum/Awilia and Ama-sukkal/Enlil-idzu; Ni 1919 and CBS 7018 | Primary editions; catalogue cross-check | BE 6/2 48 and 40, P1909 pp. 35–38; SZ1976 no. 24 identifies the case of BE 40. | The physical marking clause in BE 48 has a doubtful rendering in P1909; it is not used here to reconstruct a specific punishment technique. | Neither text records actual repudiation or punishment. BE 40 directly blocks a uniform sale-rule generalization from BE 48. | HIGH | Two agreements; not a comprehensive account of marriage law, women’s legal position, or enforcement. | Legal vulnerability can be relationship- and clause-specific rather than a permanent status inferred from gender alone. | NO DESIGN DECISION |
| E-C09 | Nippur educational tablet CBS 14156 provides evidence for instructional copying; it does not itself document an apprenticeship agreement. | Old Babylonian; no regnal date assigned here | Nippur educational artifact; no household-membership attribution made | Original study of a primary artifact | CBS 14156, illustrated in T1998 p. 45 fig. 9. | Tinney identifies teacher-model and student-practice portions. | No fees, duration of service, indenture, kin relation, or residence follows from those features. | MODERATE | Not an attested paid apprenticeship or resident pupil. | Separates skill transmission from legally specified labor service. | NO DESIGN DECISION |
| E-C10 | Nippur manumission model contracts must be treated as didactic evidence, not counted as completed releases of named people. | Old Babylonian; individual regnal dating not established here | Nippur model corpus, especially TMH 11 1 as reported by Spada | Specialist analysis; primary model edition not directly consulted | TMH 11 1, identified through SP2021 p. 287 n. 13; SP2018 not directly read. | Spada distinguishes the pedagogical corpus from actual legal records. | Her separately edited examples have mixed or uncertain provenances; not all are Nippur. | MODERATE | No event frequency or actual individual life history can be generated from these examples. | Prevents didactic names and formulae from becoming invented social biographies. | NO DESIGN DECISION |

## 4. Analysis

### 4.1 Status dimensions: documented relations, not a hierarchy

The rows below describe people **in particular documents**. They are not social classes, exhaustive biographies, or a scale from more to less free. Grouped people remain separately named; grouping indicates a shared clause, not an asserted family or dwelling. The model-contract row is explicitly non-biographical.

| Person / documented relation | Legal status / ownership | Kin connection | Residence | Labor / service obligation | Economic dependence | Mobility / change | Capacity to own / transact, if evidenced | Source basis |
|---|---|---|---|---|---|---|---|---|
| Idin-Ištar — BE 51 | Named worker; ownership status unstated | Son of Nabi-Šamaš; hired from him | Unknown | Fixed-term hire; 80 qa grain/month | Payment documented; maintenance and payee not explicit | Term ends XII/30; movement/residence not described | No independent contracting or property capacity established | E-C01; P1909 p. 43 |
| Ea-tayar — BE 28 | Adopted heir; no ownership of him stated | Adopted son of Ibkuša; Ea-turam called brother | Unknown; property shares are not a residence roster | Annual support in grain, wool, oil | Heirship linked to support performance | Change in kin/property relationship; relocation unknown | Allocated inheritance share | E-C02; P1909 pp. 29–30 |
| Ea-turam — BE 28 | Son by the wife; heir | Son of Ibkuša; brother of Ea-tayar in document | Unknown | Parallel annual support duty | Same support/inheritance connection | Unknown | Allocated inheritance share | E-C02; P1909 pp. 29–30 |
| Naramtum — BE 48 | Wife and legally constituted mother; conditional sale clause is not current enslavement | Wife of Awilia; sons attached by the agreement | Not established | Recipient of sons’ maintenance; own work unstated | Claim to support, with property-related protections | Conditional sanction only; no actual sale shown | Property interests mentioned; unrestricted capacity not established | E-C02/E-C08; P1909 pp. 35–38 |
...
| **CDLI48** — CDLI P283604 | Cuneiform Digital Library Initiative. “BE 06/2, 048 (P283604).” Artifact entry, accessed 19 September 2026. | Scholarly object catalogue and edition concordance | Istanbul Ni 1919; Nippur; Samsu-iluna 18/IV/1 | P283604; BE 6/2 48; MC 3 16; [access](https://cdli.earth/artifacts/283604) | YES: metadata and concordance. | A concordance does not constitute direct consultation of MC 3. |
| **CDLI64** — CDLI P283606 | Cuneiform Digital Library Initiative. “BE 06/2, 064 (P283606).” Artifact entry, accessed 19 September 2026. | Catalogue with textual content | Istanbul Ni 174; property redemption/sale | P283606; BE 6/2 64; MC 3 52; [access](https://cdli.earth/artifacts/283606) | YES: entry and textual content, used as an exclusion check. | This is not an adoption or a person’s manumission merely because it appears in an adoption/archive volume or is called “redemption.” |
| **CDLI4** — CDLI P266313 | Cuneiform Digital Library Initiative. “BE 06/2, 004 (P266313).” Artifact entry, accessed 19 September 2026. | Scholarly object catalogue | CBS 11152; Rim-Sin 23/VI; adoption document | P266313; BE 6/2 4; [access](https://cdli.earth/artifacts/266313) | YES: metadata; Poebel’s edition separately read. | Occupational interpretation of the adopted woman is not established in this return. |
| **T1998** — Tinney 1998 | Tinney, Steve. 1998. “Texts, Tablets, and Teaching: Scribal Education in Nippur and Ur.” Expedition 40(2): 40–50. | Original study of educational tablets and their manufacture/use | Nippur and Ur; distinguish site-specific examples | CBS 14156, p. 45 fig. 9; [access](https://www.penn.museum/documents/publications/expedition/40-2/Tinney.pdf) | YES: all six PDF image pages visually read. | Used narrowly for evidence of instruction, not for an apprenticeship contract or student residence. |
| **SP2021** — Spada 2021 | Spada, Gabriella. 2021. “I Want to Break Free: Model Contracts Recording Slave Self-Emancipation.” In dNisaba za₃-mí₂: Ancient Near Eastern Studies in Honor of Francesco Pomponio, edited by Palmiro Notizia, Annunziata Rositani, and Lorenzo Verderame, 283–300. Dubsar 19. Münster: Zaphon. | Original edition/study of model contracts | Mixed and sometimes uncertain provenances; Nippur TMH 11 1 discussed by reference | pp. 286–287, especially p. 287 n. 13; TMH 11 1; [access](https://www.academia.edu/49264064/_I_Want_to_Break_Free_Model_Contracts_Recording_Slave_Self_Emancipation) | YES: accessible author-uploaded text; TMH 11 itself was NOT consulted. | Do not turn the five edited examples into five Nippur transactions. The study’s citation of BE 6/2 8 predates the 2026 provenance explanation. |
| **VW2018** — Van Wyk 2018 | Van Wyk, Susandra J. 2018. “Inheritance Feuds in the Ur-Pabilsaĝa Archive from Old Babylonian Nippur.” Journal for Semitics 27(2), article 3989. 27 pages. | Original archival/legal interpretation | Ur-Pabilsaĝa and interconnected Nippur family dossiers | DOI 10.25159/1013-8471/3989; [access](https://unisapressjournals.co.za/index.php/JSEM/article/download/3989/3514/27186) | YES: full text available; close reading focused on cases, disagreements, and references. | Used for the genealogy disagreement and discovery leads, not as a substitute for all cited editions. |
| **S1982** — Stone 1982 | Stone, Elizabeth C. 1982. “The Social Role of the Nadītu Women in Old Babylonian Nippur.” Journal of the Economic and Social History of the Orient 25(1): 50–70. | Original sociohistorical study | Property-visible Nippur nadītu women; comparison with Sippar | DOI 10.1163/156852082X00076; [access](https://www.academia.edu/4764420/Elizabeth_C_Stone_The_Social_Role_of_the_Nad%C4%ABtu_Women_of_Nippur_Journal_of_the_Economic_and_Social_History_of_the_Orient_XXV_1982_50_70) | YES: accessible author-uploaded text, selectively. | Primary texts ARN 29 and PBS 8/2 116 remain follow-up leads, not independently verified cases here. |
| **C2011** — Culbertson, ed., 2011 | Culbertson, Laura, ed. 2011. Slaves and Households in the Near East. Oriental Institute Seminars 7. Chicago: The Oriental Institute of the University of Chicago. | Specialist research collection | Different cities and periods; selected Andrea Seri and Jonathan Tenney contributions | OIS 7; [access](https://isac-assets.s3.amazonaws.com/isac-publications/ois7.pdf?VersionId=Dc01_.QJyeviQBPD840A5LMYuvlDQVRR) | YES, selected relevant passages only; not all chapters. | Comparative use. Sippar/Larsa examples and Kassite Nippur must not become OB Nippur facts. |
| **S1987** — Stone 1987 | Stone, Elizabeth C. 1987. Nippur Neighborhoods. Studies in Ancient Oriental Civilization 44. Chicago: The Oriental Institute of the University of Chicago. | Archaeological/archive monograph | Residential Nippur evidence | SAOC 44; [access](https://isac.uchicago.edu/publications/nippur-neighborhoods) | NO full text: publisher landing page and bibliographic information only. | The landing-page description is not a substitute for the book’s context catalogue. No room-level conclusion in this report rests on having read it. |
| **SO1991** — Stone and Owen 1991 | Stone, Elizabeth C., and David I. Owen, with a contribution by John R. Mitchell. 1991. Adoption in Old Babylonian Nippur and the Archive of Mannum-mešu-liṣṣur. Mesopotamian Civilizations 3. Winona Lake, IN: Eisenbrauns. | Primary edition and archive study | Adoption and the Mannum-mešu-liṣṣur archive; individual provenances need checking | MC 3; ISBN 9780931464539; CDLI publication 1667211; [access](https://www.eisenbrauns.org/books/titles/978-0-931464-53-9.html) | NO full text: publisher information, catalogue concordances, and references in consulted scholarship only. | Do not describe every included text as an adoption; BE 6/2 64 is an immediate counterexample. |
| **G2016** — Goddeeris 2016 | Goddeeris, Anne. 2016. The Old Babylonian Legal and Administrative Texts in the Hilprecht Collection Jena. Part 1: Texts, Seal Impressions, Studies. With a contribution by Ursula Seidl. Texte und Materialien der Frau Professor Hilprecht Collection of Babylonian Antiquities im Eigentum der Friedrich-Schiller-Universität Jena 10. Wiesbaden: Harrassowitz. | Modern primary edition and archive study | Hilprecht collection, including Nippur | TMH 10; relevant page references reported by Van Wyk 2018 | NO: known through the consulted article and bibliography. | Modern readings and museum concordances require checking in the edition; do not count their secondhand citation as primary consultation. |
| **SP2018** — Spada 2018 | Spada, Gabriella. 2018. Sumerian Model Contracts from the Old Babylonian Period in the Hilprecht Collection Jena. Texte und Materialien der Frau Professor Hilprecht Collection of Babylonian Antiquities im Eigentum der Friedrich-Schiller-Universität Jena 11. Wiesbaden: Harrassowitz. | Primary edition of school/model contracts | Hilprecht collection; Nippur model-contract corpus | TMH 11; ISBN 9783447110341 | NO: identified through Spada 2021 and bibliographic records. | TMH 11 1, pp. 11–30, is the specific follow-up. TMH 10 and TMH 11 are different corpora. |
| **G2023** — Goddeeris 2023 | Goddeeris, Anne. 2023. “Economic Life in the Scribal Quarter of Nippur.” In Back to School in Babylonia, edited by Susanne Paulus, 49–57. ISAC Museum Publications 1. Chicago: Institute for the Study of Ancient Cultures. | Specialist contextual study | Nippur scribal-quarter economy | UGent record 01HQT8SB9GFVDEV15V22126C2N; [access](https://biblio.ugent.be/publication/01HQT8SB9GFVDEV15V22126C2N) | NO full text: institutional metadata only; listed PDF restricted to UGent. | A relevant missing source; its arguments have not been reconstructed from its title. |

### Research audit and completion statement

The task brief’s required areas are addressed either by checked evidence or by an explicit gap: enslavement and allocation (E-C03), sale and conditional sanctions (E-C04/E-C08), manumission (E-C05), kin support (E-C02), paid hire (E-C01), cultivation (E-C07), instruction (E-C09), temple-linked livelihood (E-C06), gender/life course (section 4.5), mobility (section 4.4), terminology (section 5.3), and documentary bias (sections 2 and 5). Enslaved family reconstruction, exact domestic residence, and formal apprenticeship remain unresolved in this return.

The source packet is unchanged. This report and its companions contain only workstream E material. No unpublished primary access, complete modern-edition collation, or comprehensive archaeological reconstruction is claimed.
